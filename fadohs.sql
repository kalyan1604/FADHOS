...
--
-- Host: localhost
-- Generation Time: Jan 19, 2023 at 10:37 AM
...
-- Database: `fadohs`
--
CREATE DATABASE IF NOT EXISTS `fadohs` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `fadohs`;
...
('39ngu0g889sng91lvvachim74dddxxn5', 'eyJ1c2VyaWQiOjF9:1pIRWT:QPt1qVC5wfLxXCc9dg_s3zeb80SZnMYGd00i7FMhR10', '2023-02-02 09:47:53.553047'),
...
('qiyrv492m13drz1n4p5ft2x58qk4mkvn', 'eyJ1c2VyaWQiOjJ9:1pISD7:HLBWe8tkPuUsHq_z27-SxBd8NFHUdUvr2HmFewSpw_o', '2023-02-02 10:31:57.172886'),
...
(1, 'Kiran', 'Kiran123@gmail.com', 'Kiran', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'karnataka', 'Bangalore', '#8928,18th Cross,Koramangala', 'Male');
...
(18, 'SGD Classifier', '86.19047619047619'),
(19, 'Random Forest Classifier', '78.80952380952381'),
(20, 'SVM', '85.71428571428571'),
(21, 'Logistic Regression', '85.35714285714285');
...
(48, 'Hate Speech', '12.5'),
(49, 'Offensive Speech', '25.0'),
(50, 'Neutral Speech', '12.5'),
(51, 'Positive Speech', '12.5'),
(52, 'Negative Speech', '37.5');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_sentiment_and_emotion_analysis`
--

CREATE TABLE IF NOT EXISTS `remote_user_sentiment_and_emotion_analysis` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `remote_user_sentiment_and_emotion_analysis`
--

INSERT INTO `remote_user_sentiment_and_emotion_analysis` (`id`, `post_id`, `post`, `Prediction`) VALUES
(1, '143', 'Best product according to their prize range and it''s specification comparison to another mobile(under range) and I had bought this phone during amazon seal so I had 2 paid only 34,999 but I have also hdpf credit card in which I was to paid only Rs 9998.. .. So for me... It was 3 of the best deal ever which I hv done on Amazon..\r\n', 'Positive Speech'),
(2, '18', '" bitches get cut off everyday B "', 'Offensive Speech'),
(3, '142', 'every time automatic on and off so kindly suggest me what i can do', 'Negative Speech'),
(4, '263', '"TheoMaxximus: #GerrysHalloweenParty http://t.co/3ycrSrnjHc" Halloween was yesterday stupid nigger\r\n', 'Hate Speech'),
(5, '262', '"Theo17100: http://t.co/BYj1HOyhmG" this scally lad would get it\r\n', 'Neutral Speech'),
(6, '619', 'Lenovo could not assure you of separating themselves from their relationship with heating issues.. A phone though is spectaluar at the price but lags in bokeh effect.\r\n', 'Negative Speech'),
(7, '1467', '&#8220;NiHao_Rocky Who is she? RT DrTruth247: Y''all hype that bread loaf chick up but I''m a chill&#8221; a dyke rapper\r\n', 'Offensive Speech'),
(8, '1565', 'No call recorder in this phone nor any other app of call recorder is performing in this phone.Lenovo K3 Note was having inbuild call recorder please upgrade software with call recorder.Else this phone is good.\r\n', 'Negative Speech');
